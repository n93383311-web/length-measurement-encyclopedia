...
In measure theory, length is most often generalised to general sets of 
...
In computer science, the length of a string is the number of characters that comprise the string. For example, the bit string 
    ...
    {\displaystyle {\texttt {10010100001}}}
